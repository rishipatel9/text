...
const SendButtom: React.FC<SENDBUTTONPROPS> = ({ handleClick }) => {
  return (
    <button
      className="group/button relative inline-flex h-7 w-7 items-center justify-center overflow-hidden rounded-full bg-white font-medium text-black transition-all duration-300 hover:w-24"
      onClick={handleClick}
    >
